...
speakers:
  - "Sam Parr (host)"
  - "Shaan Puri (host)"
  - "Andrew Wilkinson (guest, founder of Tiny)"
tags:
  - recession-preparation
  - stress-testing-businesses
  - personal-investing-strategy
  - pershing-square-holdings
  - venture-investing-in-a-downturn
  - incubating-businesses-from-pl-expenses
  - dealmaker-negotiation-service
  - buying-put-options-as-insurance
  - renting-vs-buying-real-estate
  - books-as-networking-tools
  - entrepreneur-peer-groups
---

<iframe width="560" height="315" src="https://www.youtube.com/embed/hbIgmVWZTgM" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen style="max-width:100%; aspect-ratio:16/9;"></iframe>
