...
speakers:
  - "Sam Parr (host)"
  - "Shaan Puri (host)"
  - "Patrick Campbell (guest, founder of ProfitWell, sold for $200M)"
tags:
  - trend-identification-and-the-bezos-number-framework
  - ideation-process-and-business-idea-generation
  - product-remix-framework-and-dtc-differentiation
  - pricing-strategy-and-willingness-to-pay
  - post-exit-founder-psychology-and-the-champagne-problem-cycle
  - wealth-and-happiness-research
  - financial-freedom-as-a-mindset
  - gas-station-real-estate-investment
  - body-transformation-and-accountability-coaching
---

<iframe width="560" height="315" src="https://www.youtube.com/embed/6Ui-FxhUUPU" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen style="max-width:100%; aspect-ratio:16/9;"></iframe>
...
## Riffing on Trends: Coral Bleaching, School Shootings, Teen Sex [00:05:00]
