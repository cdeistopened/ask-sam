...
speakers:
  - "Sam Parr (host)"
  - "Shaan Puri (host)"
  - "Anand (Anand Sanwal, CEO of CB Insights, guest)"
tags:
  - data-businesses
  - startup-ideas
  - sawdust-data
  ...
  - saas-pricing-data
  - college-rankings
  - business-idea-frameworks
  - ma-lessons
  - adani--hindenburg
  - fraud-signals
  - andrew-schultz-audience-strategy
  - bootstrapping-and-equity
---

<iframe width="560" height="315" src="https://www.youtube.com/embed/TihCw_faxp8" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen style="max-width:100%; aspect-ratio:16/9;"></iframe>
