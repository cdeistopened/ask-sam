...
speakers:
  - "Shaan Puri (host)"
  - "Sam Parr (host)"
  - "Balaji Srinivasan (guest, entrepreneur/investor)"
tags:
  - media-and-tech-history
  - crypto-and-blockchain
  - 1729com-newsletter
  - network-state--cloud-communities
  - startup-cities
  - decentralized-truth-and-crypto-oracles
  - idea-maze
  - genomics-and-biotech
  - teleport-and-digital-nomadism
  - science-vs-math
  - hiring-from-twitter-vs-universities
---

<iframe width="560" height="315" src="https://www.youtube.com/embed/lfd6M9y9_TI" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen style="max-width:100%; aspect-ratio:16/9;"></iframe>
