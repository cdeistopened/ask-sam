...
speakers:
  ...
  - Shaan Puri (host)
topics:
  - Logan Paul and PRIME energy drink
  - influencer-to-brand playbook
  - Vancouver live show recap
  - Anya and the Rooted panic attack app
  - Vessi shoes bootstrapped success
  - offshore tax strategies (Nike, Apple)
...
And then one of the guys, I go, "Yeah, just DM me on Twitter." He goes, "Okay cool, my handle is F***in Manly." And I was like, all right, that's badass. He said, "My wife has a big Instagram following for women's stuff so I decided to create F***in Manly to counteract it." I thought that was awesome.
