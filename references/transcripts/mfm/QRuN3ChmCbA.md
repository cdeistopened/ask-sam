---
title: "Inside Warren Buffett's Inner Circle: How The Elite Think"
youtube_id: "QRuN3ChmCbA"
...
speakers:
  ...
  - Guy Spier (guest)
topics:
  - The Posy — Buffett investor study group (Whitney Tilson, Bill Ackman)
  - Farmer Mac / Bill Ackman short — due diligence story
  - Gordon Gekko mentality to value investing shift
  - Tony Robbins / NLP / handwritten thank-you notes
  - Warren Buffett's holiday card / personal gestures
  - Kobe Bryant people skills (FaceTime on birthdays, volume shooter story)
  - Reticular activating system (red/blue exercise)
  - Cloning Buffett — ordering annual reports, sitting in his shoes
  - Two gas stations story (Good to Great) / building engines
  - Berkshire Hathaway as investment (community effect vs. index)
  - Fund performance — 80 basis points over S&P net, 7-8 years underperformance
  - Finite vs. infinite games (investing as infinite game)
  - "Just this once" decision framework
  - Library as cocktail party / reading strategy
  - Buffett letters, Charlie Munger, Poor Charlie's Almanack
summary: >
  Guy Spier — value investor, author of The Education of a Value Investor — joins Shaan to trace his path from Gordon Gekko wannabe at a Stratton Oakmont-style firm to Buffett disciple managing money from Zurich. Covers the Farmer Mac short that Bill Ackman called to warn him about, the power of handwritten notes and personal gestures, how to "clone" a mentor you'll never meet, and the psychology of compounding through years of underperformance. One of the richer guest conversations in the batch.
status: polished
