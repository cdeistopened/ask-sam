---
title: "Investigating The Mormon's $100 Billion Hedge Fund"
youtube_id: "QAgaLbML0QQ"
url: "https://www.youtube.com/watch?v=QAgaLbML0QQ"
date: 2026-01-21
speakers:
  - Sam Parr (host)
  - Shaan Puri (host)
  - Ben Wilson (guest, Mormon member, joins briefly)
topics:
  - Religion as the greatest business ever invented (LTV, TAM, no COGS, volunteers)
  - Mormon Church $100B hedge fund (Ensign Peak, 13 shell companies)
  - Ensign Peak investment portfolio (Apple, Microsoft, Tesla, 2% of Florida land)
  - Ministry Brands — church software roll-up ($100M EBITDA)
  - Team Jorge — Israeli psyops-as-a-service company ($6M to meddle in an election)
  - Fake social media profiles (39,000 avatars), coordinated narrative deployment
  - Emmanuel the Emu fake death experiment
  - The Thunderclap (Steve Bartlett's coordinated social media strategy)
  - Parallel Live app — fake livestream simulator for status signaling
  - James Currier (NFX) meeting takeaways
  - McDonald's vs. Michelin star content spectrum (audience quality vs. quantity)
  - Stan's four rules for a 20-year business partnership
  - Network density and physical proximity (Silicon Valley thesis)
  - "Be an API" — building an open interface for network value exchange
  - Zuckerberg buying WhatsApp / lucky-pattern recognition
summary: >
  Sam and Shaan cover four topics: why religion is the greatest business model ever invented (with Mormon's $100B hedge fund as exhibit A), Team Jorge — the Israeli company that runs psyops-as-a-service, the Parallel Live fake livestream app, and Shaan's detailed notes from a meeting with James Currier of NFX, including partnership rules from Stan (Currier's co-founder) and the network density argument for staying in Silicon Valley.
status: polished
