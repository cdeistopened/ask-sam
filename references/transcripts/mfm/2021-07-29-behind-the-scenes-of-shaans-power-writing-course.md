...
speakers:
  ...
  - Sam Parr (host)
topics:
  - power writing course breakdown
  - course economics and P&L
  - smart contracts and Solidity bootcamp idea
  - bitcoin short squeeze explanation
  - Maven and live vs. recorded courses
  - Swimply (Airbnb for pools)
  - ClassPass for online courses
  - Every.to newsletter bundle
  - gas station future / electric vehicles
  - Buc-ee's as destination model
  - Cafe X and automation
summary: >
