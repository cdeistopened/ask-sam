...
speakers:
  ...
  - Shaan Puri (host)
topics:
  - Nassim Taleb tweet — if you gave an investor tomorrow's news, they'd go bust in a year
  - Crystal ball experiment — 118 financial professionals given 15 WSJ front pages in advance
  - Results: half lost money; 1-in-6 lost everything; average gain 3.2% (market was up 15%/year)
  - What the pros did differently — bet sizing, not trading every day, 57% vs. 51% direction accuracy
  - Ray Dalio quote: "He who lives by the crystal ball will die eating shattered glass"
  - Hackers who accessed advance press releases and got rich on merger announcements
  - ChatGPT as thought partner / therapist / life coach (projects folder workflow)
  - Uploading KPIs, health books, body measurements, company financials to ChatGPT Projects
  - Asking ChatGPT to ask YOU questions (vs. answering your questions)
  - Tim Ferriss: "If you want confusion and heartache, ask vague questions"
  - Better questions: "What would make this certainly fail?" vs. "How can I make this succeed?"
  - "What are we stupid for not doing right now?" and Amazon's "dogs not barking" questions
  - Futilo — first live birth using egg matured outside the body (IVF breakthrough)
  - AI coding interview cheat tools (LeetCode Wizard) doing $15K/month MRR
  - Satya Nadella's 2014 "ambient intelligence" memo
  - "Why am I not already a billionaire?" as a diagnostic question
summary: >
  Two main segments: (1) a breakdown of the crystal ball experiment — what happens when financial professionals are given tomorrow's newspaper before placing trades, based on Nassim Taleb's conjecture — and (2) a detailed walkthrough of how Sam and Shaan are actually using ChatGPT as a daily operating system, including the counter-intuitive move of asking ChatGPT to ask you questions rather than answering them.
status: polished
