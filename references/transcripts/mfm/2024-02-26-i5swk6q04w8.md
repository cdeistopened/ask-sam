...
topics:
  ...
  - loyalty
  - risk-taking
  - "fu money" alternatives
  - book development
  - tax advisors
summary: >
  Shaan walks through three "all-in individuals" — Egon Durban (Silver Lake), Ari Emanuel (WME), and Dana White (UFC) — exploring what they have in common: extreme concentration of bets, savage intensity, and deep loyalty to a small circle. Sam and Shaan then riff on the philosophy behind loyalty, alternative versions of "fu money," and how to handle ego when someone tells you the hard truth.
status: polished
