---
title: "How We Got Our First 100 Customers (No BS, Specific Details)"
youtube_id: "tpwkJjGz-R8"
...
1. **Piggyback** — use existing platform traffic (Craigslist, Reddit, App Store)
2. **Floor-to-floor** — brute force, hand-to-hand combat, just go get them
3. **The magnet** — ultra-niche offer that self-selects the perfect early adopters
4. **Made-to-stick infographic** — hyperlocal, brand-named, funny, built to share
5. **No-risk offer** — eliminate the trust barrier by removing all downside for the customer
6. **Piss in the pond** — find the smallest, most obsessed community and tell your underdog story
7. **Personal story + sequential content** — reveal the problem, not the product
8. **David Blaine spectacle** — public stunt, stakes on the line, build in public with a real narrative
