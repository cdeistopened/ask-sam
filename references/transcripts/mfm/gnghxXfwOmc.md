...
speakers:
  ...
  - Shaan Puri (host)
topics:
  - Sam's embarrassing case of mistaken identity (Hassan the comedian)
  - How public speaking works as a business model (books → NYT bestseller → speaking rate)
  - Obama at $1.2M / Oprah at $1M per speech
  - Casey Neistat at HustleCon for $25K plus a $6K private flight
  - Gary Vee asking price: $100K or $100K in books bought
  - WSB (Washington Speaker Bureau) — $150M revenue, acquired for $15M in 2000
  - Coach K's speaking fees ($70K+) vs. his actual coaching salary
  - Robert De Niro's insane movie contract (8 days, $11M plus Gulfstream, Ritz, Puerto Rico, etc.)
  - Parallel opportunity: a speaker bureau for podcasters and Twitter personalities
  - Sarah Moore / eggcartons.com — Harvard grad, 50 unpaid Craigslist interns, 400K companies screened, acquired with 75% bank debt + 25% seller note
  - eggcartons.com: blind from deodorant study, faxed photo of herself to thousands of businesses, fake IDs for library interns, nearly buried in India
summary: >
