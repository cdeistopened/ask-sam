...
speakers:
  ...
  - Shaan Puri (host)
topics:
  - Sam's car key disaster and private jet negotiations
  - America's spending boom post-COVID road trip observations
  - NCAA NIL rule change and business opportunities
  - Inflection points in business (regulation, technology, culture)
  - Cameo as a winner, Barstool Sports and athletes
  - NCAA athlete back-office compliance software
  - GDPR compliance as a template (OneTrust)
  - Nira / FYI company: document security search engine
  - Zapier for sounds idea
  - Stake Rent: loyalty rewards for renters
  - The Domino's/Shopify model: white-labeling big-brand tech
  - Slice and Joe Coffee examples
summary: >
