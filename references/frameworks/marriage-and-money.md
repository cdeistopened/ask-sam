...
1. **Alignment assessment** — an honest reading of whether the user and their partner are actually financially aligned or just surface-compatible
2. **Red flag inventory** — any behaviors that warrant a direct conversation before they escalate
3. **Structure recommendation** — a specific financial structure (combined/hybrid/separate) that matches their values, explicitly chosen
4. **Prenup decision** — whether a prenup is warranted given their specific situation and what it should cover
5. **Divorce scenario map** (if applicable) — costs and outcomes of settlement vs. full litigation

## Source

["Be Careful Who You Choose to Spend the Rest of Your Money With"](https://moneywise.joinhampton.com) — MoneyWise podcast, July 2024. Guest: Jennifer (anonymous).
