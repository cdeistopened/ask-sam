...
1. **Pillar audit** — where the user is strong and where there are gaps
2. **Priority pillar** — the one that, if improved, would most change their life
3. **Concrete next step** for each underperforming pillar (one action, not a plan)
4. **The "enough" reframe** — what financial freedom actually looks like for them, so they can stop running toward an arbitrary number

## Source

["$1B and Counting: Steve Houghton's Five Pillars for Living a Truly Wealthy Life"](https://moneywise.joinhampton.com) — MoneyWise podcast, December 2024.
