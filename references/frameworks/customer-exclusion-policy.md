...
1. **Ideal customer profile** — what success requires the customer to bring
2. **Failed customer pattern** — what your refunds and churns have in common
3. **Exclusion policy statement** — the specific, enforceable rule
4. **Rejection language** — warm, specific, with a path forward for excluded customers
5. **Long-term economics brief** — the real cost of non-ideal customers
