...
1. **Current positioning diagnosis** — vendor or advisor, and the evidence
2. **Long-term commitment statement** — drafted language for their market
3. **Customer journey gap map** — where the business goes quiet
4. **Counterintuitive policy proposal** — one policy that signals they're not a vendor
5. **Expert positioning reframe** — how to communicate expertise-first
