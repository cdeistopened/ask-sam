...
| Phase | Timeline | Primary Risk | What To Do |
|-------|----------|-------------|-----------|
| Courtship | Weeks-months | Misaligned vision | Build relationship; articulate 1+1=3 |
| LOI and structure | Days-weeks | Bad deal terms | Get M&A counsel; understand every term |
| Due diligence | 30-90 days | Founder impatience / new ventures | Stay engaged; do NOT start new projects |
| Close | Days | Last-minute repricing | Document everything; hold on reps & warranties |
| Post-close | Months-years | Earnout metric manipulation | Negotiate metric definitions upfront |
